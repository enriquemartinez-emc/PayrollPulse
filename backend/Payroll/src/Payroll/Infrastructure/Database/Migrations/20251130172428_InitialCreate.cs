...
namespace Payroll.Infrastructure.Database.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    compensation_type = table.Column<string>(
                        type: "character varying(32)",
                        maxLength: 32,
                        nullable: false
                    ),
                    calculation_type = table.Column<string>(
                        type: "character varying(32)",
                        maxLength: 32,
                        nullable: false
                    ),
                    rate_or_amount = table.Column<decimal>(
                        type: "numeric(18,4)",
                        precision: 18,
                        scale: 4,
                        nullable: false
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    total_earnings_amount = table.Column<decimal>(type: "numeric", nullable: false),
                    total_earnings_currency = table.Column<string>(type: "text", nullable: false),
                    total_deductions_amount = table.Column<decimal>(
                        type: "numeric",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    override_rate_or_amount = table.Column<decimal>(
                        type: "numeric",
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    payroll_run_id = table.Column<Guid>(type: "uuid", nullable: false),
                    base_salary_amount = table.Column<decimal>(
                        type: "numeric(18,2)",
                        precision: 18,
                        scale: 2,
                        nullable: false
                    ),
                    base_salary_currency = table.Column<string>(
                        type: "character varying(3)",
                        maxLength: 3,
                        nullable: false
                    ),
                    net_pay_amount = table.Column<decimal>(
                        type: "numeric(18,2)",
                        precision: 18,
                        scale: 2,
                        nullable: false
                    ),
                    net_pay_currency = table.Column<string>(
                        type: "character varying(3)",
                        maxLength: 3,
                        nullable: false
                    ),
                    period_end = table.Column<DateOnly>(type: "date", nullable: false),
                    period_start = table.Column<DateOnly>(type: "date", nullable: false),
                    total_earnings_amount = table.Column<decimal>(
                        type: "numeric(18,2)",
                        precision: 18,
                        scale: 2,
                        nullable: false
                    ),
                    total_earnings_currency = table.Column<string>(
                        type: "character varying(3)",
                        maxLength: 3,
                        nullable: false
                    ),
                    ...
                    total_deductions_currency = table.Column<string>(
                        type: "character varying(3)",
                        maxLength: 3,
                        nullable: false
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "employee_payroll_policies");

            migrationBuilder.DropTable(name: "payroll_run_failures");

            migrationBuilder.DropTable(name: "payslip_items");

            migrationBuilder.DropTable(name: "users");

            migrationBuilder.DropTable(name: "payroll_policies");
